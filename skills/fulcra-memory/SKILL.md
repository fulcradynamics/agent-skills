...
To perform memory tracking operations, agents should prefer using the Fulcra CLI, though Fulcra MCP tools are fully supported as a first-class alternative.
