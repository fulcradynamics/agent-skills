...
- **Rule:** The cron payload must say something like: "You are waking up to do X. Before starting, you MUST read `team/<team-name>/progress.md`, `team/<team-name>/role.md`, and your specific `member/<agent-name>/progress.md` to establish context."
