...
- Before overwriting the persisted state file, perform a version check (or ensure you downloaded the latest state) to avoid silently dropping metadata from other runs.
