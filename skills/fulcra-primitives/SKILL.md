...
description: "A plain, no-nonsense introduction to the Fulcra CLI, covering core primitives (data types and versioned file uploads). Use when learning or explaining Fulcra CLI basics, creating data types, or working with versioned file uploads for the first time."
license: "MIT"
metadata:
